...
function Profile({ faceFont, userName, setUserName, amountGoal, setAmountGoal, unitGoal, setUnitGoal, spanGoal, setSpanGoal }) {
  return (
    <div style={{ position: 'absolute', inset: 0,
      ...
      <div style={{ position: 'absolute', top: 132, left: 0, right: 0, padding: '20px 20px' }}>
        ...
        <div style={{display: 'flex', gap: '10px', width: '100%'}}>
            <input type="number" value={amountGoal} onChange={(e) => setAmountGoal(e.target.value)}
                placeholder="0" min={0} style={{ display: 'block', width: '25%', marginTop: 8,
                padding: '12px 14px', fontFamily: faceFont, fontSize: 17, color: '#2e261b',
                background: 'rgba(255,255,255,0.55)', border: '1px solid rgba(120,100,60,0.25)',
                borderRadius: 10, outline: 'none', boxSizing: 'border-box' }} />
            <select value={unitGoal} onChange={(e) => setUnitGoal(e.target.value)}
                placeholder="Set reading goal"  style={{ display: 'block', width: '40%', marginTop: 8,
                padding: '12px 14px', fontFamily: faceFont, fontSize: 17, color: '#2e261b',
                background: 'rgba(255,255,255,0.55)', border: '1px solid rgba(120,100,60,0.25)',
                borderRadius: 10, outline: 'none', boxSizing: 'border-box' }} >
            ...
            <select value={spanGoal} onChange={(e) => setSpanGoal(e.target.value)}
            placeholder="Set reading goal" style={{ display: 'block', width: '40%', marginTop: 8,
            padding: '12px 14px', fontFamily: faceFont, fontSize: 17, color: '#2e261b',
            background: 'rgba(255,255,255,0.55)', border: '1px solid rgba(120,100,60,0.25)',
            borderRadius: 10, outline: 'none', boxSizing: 'border-box' }} >
        ...
        <button onClick={() => {setAmountGoal(''); setUnitGoal(''); setSpanGoal('');}}
